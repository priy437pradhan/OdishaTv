...
export const sampleData = [
  { id: 1, title: 'Rising sea levels threaten.', urlToImage: watch1, category: 'World', section: 'watch_card', storyIntro: 'Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health. Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health.Government announces new infrastructure investment plan.',
    primaryTag: 'Politics',
    secondaryTag: 'Climate Change' },
  { id: 2, title: 'Government announces new infrastructure investment plan.', urlToImage: watch2, category: 'World', section: 'watch_card',   storyIntro: 'Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health. Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health.Government announces new infrastructure investment plan.',
    primaryTag: 'Technology',
    secondaryTag: 'Renewable Energy' },
  { id: 3, title: 'New study links diet to improved mental health.', urlToImage: watch3, category: 'World', section: 'watch_card',  storyIntro: 'Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health. Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health.Government announces new infrastructure investment plan.',
    primaryTag: 'Politics',
    secondaryTag: 'Peace' },
  ...
  { id: 7, title: 'Global Technology AdvancesBreakthrough in genetic research.', urlToImage: TopTrending,category: 'World', section: 'TopTrending_card', storyIntro: 'Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health. Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health.Government announces new infrastructure investment plan..',
    primaryTag: 'Health',
    secondaryTag: 'Research' },
  { id: 8, title: 'Breakthrough in genetic research could extend human lifespan.', urlToImage: TopTrending2, category: 'World', section: 'TopTrending_card', storyIntro: 'Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health. Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health.Government announces new infrastructure investment plan.',
    primaryTag: 'Health',
    secondaryTag: 'Research' },
  { id: 9, title: 'Government enacts sweeping reforms to healthcare system.', urlToImage: TopTrending3, category: 'World', section: 'TopTrending_card', storyIntro: 'Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health. Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health.Government announces new infrastructure investment plan.',
    primaryTag: 'Environment',
    secondaryTag: 'Protest' },
  { id: 10, title: 'Major sports event postponed due to health concerns.', urlToImage: TopTrending4, category: 'World', section: 'TopTrending_card', storyIntro: 'Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health. Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health.Government announces new infrastructure investment plan.',
    primaryTag: 'Environment',
    secondaryTag: 'Wildfires' },
  { id: 111, title: 'Global Cultural Events  enacts sweeping reforms to healthcare system', urlToImage: Img, category: 'World', section: 'TopTrending_card',storyIntro: 'A major tech company has revealed an innovative new product.Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health. Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health.Government announces new infrastructure investment plan.',
    primaryTag: 'Technology',
  ...
  { id: 11, title: 'Major sports event postponed due to health concerns.', urlToImage: TopTrending5, category: 'Politics', section: 'TopTrending_card',storyIntro: 'Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health. Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health.Government announces new infrastructure investment plan.',
    primaryTag: 'Technology',
  ...
  { id: 14, title: 'Tech company faces backlash over privacy concerns.', urlToImage: TopTrending8, category: 'Politics', section: 'TopTrending_card',
    storyIntro: 'A recent study has found a strong connection between diet and mental health.',
    primaryTag: 'Health',
  ...
  { id: 15, title: 'Major oil spill devastates marine ecosystem.', urlToImage: TopTrending6, category: 'Politics', section: 'TopTrending_card',
    storyIntro: 'Scientists have made a significant breakthrough in genetic research, potentially extending human lifespan.',
    primaryTag: 'Science',
    secondaryTag: 'Genetics' },
  ...
  { id: 17, title: 'Major oil spill devastates marine ecosystem.', urlToImage: TopTrending11, category: 'Politics', section: 'TopTrending_card',
    storyIntro: 'Major healthcare reforms have been enacted by the government.',
    primaryTag: 'Health',
    secondaryTag: 'Reform' },
  { id: 19, title: 'World leaders convene for climate change summit in Paris ', urlToImage: LiveNewsCard, category: 'Politics', section: 'LiveNewsCard_card' , storyIntro: 'New cancer research breakthroughs are providing fresh hope for patients.',
    primaryTag: 'Health',
    secondaryTag: 'Research'},
  { id: 18, title: 'New technology promises to revolutionize renewable energy', urlToImage: liveNewsItem2, category: 'Politics', section: 'liveNewsItem_card',
    storyIntro: 'A recent study has found a strong connection between diet and mental health. Global leaders are meeting in Paris to discuss urgent climate change issues.Rising sea levels threaten coastal cities worldwide.New study links diet to improved mental health.',
    primaryTag: 'Health',
    secondaryTag: 'Nutrition' },
  ...
  { id: 20, title: 'Historic peace agreement signed in the Middle East', urlToImage: Web1, category: 'Business', section: 'Topstories_card' , storyIntro: 'A landmark peace agreement has been signed in the Middle East.',
    primaryTag: 'Politics',
    secondaryTag: 'Peace' },
  { id: 21, title: 'Major cyberattack targets global financial institutions.', urlToImage: Web2, category: 'Business', section: 'Topstories_card', storyIntro: 'Massive wildfires in California are causing widespread evacuations.',
    primaryTag: 'Environment',
    secondaryTag: 'Wildfires' },
  { id: 22, title: 'Breakthrough in cancer research offers new hope for patients.', urlToImage: Web3, category: 'Business', section: 'Topstories_card',
    storyIntro: 'Sea levels are rising at an unprecedented rate, threatening coastal cities globally.',
    primaryTag: 'Environment',
    secondaryTag: 'Climate Change' },
  { id: 23, title: 'Economic PoliciesGlobal protests demand action on climate change.', urlToImage: Web4, category: 'Business', section: 'FirstStories_card' ,
    storyIntro: 'The government has unveiled a new plan to invest heavily in infrastructure.',
    primaryTag: 'Politics',
    secondaryTag: 'Infrastructure'},
  ...
  { id: 27, title: 'Economic sanctions imposed on rogue nation.', urlToImage: singleCardItemOne3, category: 'Business', section: 'singleCardItemOne_card',
    storyIntro: 'A major sports event has been postponed because of health and safety concerns.',
    primaryTag: 'Sports',
    secondaryTag: 'Health' },
  { id: 28, title: 'Wildfires rage across California, prompting evacuations.', urlToImage: singleCardItemTwo, category: 'Business', section: 'singleCardItemTwo_card' , storyIntro: 'Global leaders are meeting in Paris to discuss urgent climate change issues.',
    primaryTag: 'Environment',
    secondaryTag: 'Climate Change'},
  { id: 29, title:'Global protests demand action on climate change.', urlToImage: singleCardItemTwo3, category: 'Technology', urlToImage: singleCardItemTwo2, category: 'Business', section: 'singleCardItemTwo_card' , storyIntro: 'Global leaders are meeting in Paris to discuss urgent climate change issues.',
    primaryTag: 'Environment',
    secondaryTag: 'Climate Change'},
  ...
  { id: 32, title: 'Major tech company invests in space exploration invests in space exploration invests in space exploration .', urlToImage: cardThreeData, category: 'Technology', section: 'cardThreeData_card',
    ...
    primaryTag: 'Health',
    secondaryTag: 'Reform' },
  { id: 33, title: 'Cybersecurity UpdatesMajor tech company invests in space exploration.', urlToImage: cardTwoData, category: 'Technology', section: 'cardTwoData_card', storyIntro: 'A significant cyberattack has hit global financial institutions.',
    primaryTag: 'Technology',
    secondaryTag: 'Cybersecurity'},
  { id: 34, title: 'Software Rising healthcare costs create financial strain for individuals.', urlToImage: cardTwoData2, category: 'Technology', section: 'cardTwoData_card', storyIntro: 'New cancer research breakthroughs are providing fresh hope for patients.',
    primaryTag: 'Health',
    secondaryTag: 'Research' },
  { id: 35, title: 'Government unveils plan to modernize public transportation.', urlToImage: cardTwoData3, category: 'Technology', section: 'cardTwoData_card',  storyIntro: 'A landmark peace agreement has been signed in the Middle East.',
    primaryTag: 'Politics',
    secondaryTag: 'Peace' },
  { id: 36, title: 'Rising cyber threats prompt calls for increased cybersecurity.', urlToImage: cardTwoData4, category: 'Technology', section: 'cardTwoData_card', storyIntro: 'A leading tech firm is making significant investments in space exploration.',
    primaryTag: 'Technology',
    secondaryTag: 'Space' },
  ...
  { id: 62, title: 'Government unveils plan to improve national healthcare system Rising unemployment rates spark concerns about economic stability.', urlToImage: videoSec, category: 'Education', section: 'Video_card' },
  { id: 63, title: 'Rising unemployment rates spark concerns about economic stability .', urlToImage: photoSec, category: 'Education', section: 'Photo_card' },
  // { id: 64, title: 'Educational Innovations', urlToImage: Img, category: 'Education', section: 'VideoPhoto_card' },
  { id: 65, title: 'Major breakthrough in brain-computer interface technology.', urlToImage: photoSubSec1, category: 'Education', section: 'PhotoSub_card' },
  { id: 66, title: 'Government introduces new measures to combat cybercrime.', urlToImage: photoSubSec2, category: 'Education', section: 'PhotoSub_card' },
  { id: 67, title: 'Major discovery advances understanding of climate change.', urlToImage: videoSubSec1, category: 'Education', section: 'VideoSub_card' },
  { id: 68, title: 'Education PolicyMajor discovery advances understanding of climate change.', urlToImage: videoSubSec2, category: 'Education', section: 'VideoSub_card' },
