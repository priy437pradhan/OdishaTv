...
const NewsList = ({
  ...
  singleCardItem =[
    {id:1, imageUrl: testing, headline: 'Single News Headline' },
  ...
  liveSubCardItem =[
    { id: 11,imgSrc: testing, title: 'Live Subcard News Headline', content: 'xxxxxxxxx' },
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[6fr_2fr_4fr] gap-6 mt-12 lg:mt-48 px-4 lg:px-0">
